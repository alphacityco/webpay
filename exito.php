...
?></td>
                            ...
                            <td
                                align=left><?php
                                echo
                                $TBK_CODIGO_AUTORIZACION[1];
?></td>
                            <th align=left>Fecha Contable:</th>
                            <td
                                align=left><?php
                                echo
                                $TBK_FECHA_CONTABLE[1];
?></td>
                        </tr>
                        <tr valign=top >
                            <th
                            ...
                            <td
                                align=left><?php
                                echo
                                $TBK_FECHA_TRANSACCION[1];
?></td>
                            <th
                                align=left>Hora
                                Transacci&oacute;n:</th>
                            <td align=left>
                            <th align = left>tarjeta
                                <?php
                                echo
                                $TBK_HORA_TRANSACCION[1];
                                ?></td>
                                de
                                cr&eacute;dito:</th>
                            <td align=left>XXXXXXXXXXXX<?php
                                echo
                                $TBK_FINAL_NUMERO_TARJETA[1];
                                ?></td>
                        </tr>
                        <tr valign=top>
                            <th
                            ...
                            <td
                                align=left><?php
                                echo
                                $TBK_TIPO_TRANSACCION[1];
                                ?></td>
                            <th align=left>Tipo Pago:</th> echo
                            <td 
                                align=left>
